...
export interface ISetCleaningSubstanceTime {
  type: string,
  payload: number
}
...
export const SET_CLEANING_SUBSTANCE_TIME = 'SET_CLEANING_SUBSTANCE_TIME'
export const SET_CLEANING_SUBSTANCE_TIME_REMAIN = 'SET_CLEANING_SUBSTANCE_TIME_REMAIN'
